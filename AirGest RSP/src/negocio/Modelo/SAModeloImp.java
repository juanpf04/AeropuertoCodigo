...
public class SAModeloImp implements SAModelo {
	/** 
	* (non-Javadoc)
	* @see SAModelo#altaModelo(TModelo tModelo)
	* @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
	...
	*/
	...
	/** 
	* (non-Javadoc)
	* @see SAModelo#consultarModelo(int id)
	* @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
	...
	/** 
	* (non-Javadoc)
	* @see SAModelo#consultarTodosModelos()
	* @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
	...
	/** 
	* (non-Javadoc)
	* @see SAModelo#modificarModelo(TModelo modelo)
	* @generated "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
