...
public class DAOModeloAerolineaImp implements DAOModeloAerolinea {
	/** 
	* (non-Javadoc)
	* @see DAOModeloAerolinea#vincular(int idModelo, int idAerolinea)
	* @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
	...
	/** 
	* (non-Javadoc)
	* @see DAOModeloAerolinea#desvincular(int idModelo, int idAerolinea)
	* @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
	...
	/** 
	* (non-Javadoc)
	* @see DAOModeloAerolinea#comprobarVinculacion(int idModelo, int idAerolinea)
	* @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	*/
