...
public class DAOAerolineaImpTest {
	...
	public void alta_aerolinea_test() {
		...
		TAerolinea aerolinea = new TAerolinea(1, "nombre", true);
	...
	public void leer_aerolinea_por_nombre_test() {
		...
		assertEquals("la aerolinea con nombre nombre es el id 1", 1, da.leerAerolineaPorNombre("nombre").getId());
	}
	...
	public void modificar_aerolinea_test() {
		...
		TAerolinea aerolinea = new TAerolinea(3, "florencia",true);
	...
	public void baja_aerolinea_test() {
		...
		assertTrue("No se ha dado de baja", da.bajaAerolinea(3));
	}
